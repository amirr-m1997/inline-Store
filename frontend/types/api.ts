...
export type SiteHeroCategorySpotlight = { id: number; title: string; description: string; image: string | null; button_text: string; category_slug: string; category_name: string; placement: "after_featured" | "after_best_sellers" | "between_newest_discounts" | "after_discounts" | "after_low_stock"; side: "right" | "left"; order: number };
