...
export type ProductSummary = { id: number; name: string; slug: string; code: string; sku?: string; unit: string; shortDescription?: string; category?: { name: string }; brand?: string; media: ProductMedia[]; pricing?: ProductPricing; availability: ProductAvailability; technicalHighlights?: ProductSpecification[]; documents?: ProductDocument[]; purchaseMode?: "cart" | "quote" };
