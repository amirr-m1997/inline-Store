...
export default function AccountPage() {
  ...
  const saveProfile = async (event: React.FormEvent) => {
    ...
    setMessage("");
    try {
      setProfile(normalizeProfile(await updateProfile<Customer>(profile)));
