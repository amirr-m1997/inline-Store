...
from .models import Category, Product, ProductImage, SupplyBrand
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ("id", "code", "name", "name_fa", "name_en", "slug", "category", "category_tree", "unit", "description", "technical_specs", "is_active", "images", "on_hand_quantity", "reserved_quantity", "available_quantity", "price", "created_at", "updated_at")
...
class ProductDetailSerializer(ProductSerializer):
    ...
    class Meta(ProductSerializer.Meta):
        fields = ProductSerializer.Meta.fields + (
            "sku", "inventory", "pricing", "technical_specifications", "related_products", "service_advantages",
        )
